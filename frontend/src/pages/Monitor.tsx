      ...
      {status && (
        <div className="grid grid-cols-4 gap-4 text-center">
          <div className="bg-gray-800 rounded-lg p-3">
            ...
            <div className="text-2xl font-bold text-red-400">{status.pv.toFixed(1)}°C</div>
          </div>
          <div className="bg-gray-800 rounded-lg p-3">
            <div className="text-sm text-gray-400">SP</div>
            <div className="text-2xl font-bold text-blue-400">{status.sp.toFixed(1)}°C</div>
          </div>
          <div className="bg-gray-800 rounded-lg p-3">
            <div className="text-sm text-gray-400">Output</div>
            <div className="text-2xl font-bold text-green-400">{status.mv.toFixed(1)}%</div>
          </div>
          <div className="bg-gray-800 rounded-lg p-3">
            <div className="text-sm text-gray-400">Points</div>
            <div className="text-2xl font-bold text-gray-300">{readings.length}</div>
          </div>
        </div>
      )}
    </div>
